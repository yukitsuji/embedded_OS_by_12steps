...
#define MASK_ADDRESSES (1 << 0)
#define MASK_ALIGN_300 (1 << 1)
#define MASK_H8300H (1 << 2)
#define MASK_INT32 (1 << 3)
#define MASK_NORMAL_MODE (1 << 4)
#define MASK_QUICKCALL (1 << 5)
#define MASK_RELAX (1 << 6)
#define MASK_H8300S_1 (1 << 7)
#define MASK_MAC (1 << 8)
#define MASK_SLOWBYTE (1 << 9)
#define MASK_H8300SX (1 << 10)

#define TARGET_ADDRESSES ((target_flags & MASK_ADDRESSES) != 0)
#define TARGET_ALIGN_300 ((target_flags & MASK_ALIGN_300) != 0)
#define TARGET_H8300H ((target_flags & MASK_H8300H) != 0)
#define TARGET_INT32 ((target_flags & MASK_INT32) != 0)
#define TARGET_NORMAL_MODE ((target_flags & MASK_NORMAL_MODE) != 0)
#define TARGET_QUICKCALL ((target_flags & MASK_QUICKCALL) != 0)
#define TARGET_RELAX ((target_flags & MASK_RELAX) != 0)
#define TARGET_H8300S_1 ((target_flags & MASK_H8300S_1) != 0)
#define TARGET_MAC ((target_flags & MASK_MAC) != 0)
#define TARGET_SLOWBYTE ((target_flags & MASK_SLOWBYTE) != 0)
#define TARGET_H8300SX ((target_flags & MASK_H8300SX) != 0)
...
enum opt_code
{
  ...
  OPT_maddresses = 983,                      /* -maddresses */
  OPT_malign_300 = 984,                      /* -malign-300 */
  OPT_mh = 985,                              /* -mh */
  OPT_mint32 = 986,                          /* -mint32 */
  OPT_mn = 987,                              /* -mn */
  OPT_mquickcall = 988,                      /* -mquickcall */
  OPT_mrelax = 989,                          /* -mrelax */
  OPT_ms = 990,                              /* -ms */
  OPT_ms2600 = 991,                          /* -ms2600 */
  OPT_mslowbyte = 992,                       /* -mslowbyte */
  OPT_msx = 993,                             /* -msx */
  OPT_n = 994,                               /* -n */
  OPT_no_canonical_prefixes = 995,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 996,               /* -no-integrated-cpp */
  OPT_nocpp = 997,                           /* -nocpp */
  OPT_nodefaultlibs = 998,                   /* -nodefaultlibs */
  OPT_nostartfiles = 999,                    /* -nostartfiles */
  OPT_nostdinc = 1000,                       /* -nostdinc */
  OPT_nostdinc__ = 1001,                     /* -nostdinc++ */
  OPT_nostdlib = 1002,                       /* -nostdlib */
  OPT_o = 1003,                              /* -o */
  OPT_p = 1004,                              /* -p */
  OPT_pass_exit_codes = 1005,                /* -pass-exit-codes */
  OPT_pedantic = 1006,                       /* -pedantic */
  OPT_pedantic_errors = 1007,                /* -pedantic-errors */
  OPT_pg = 1008,                             /* -pg */
  OPT_pie = 1009,                            /* -pie */
  OPT_pipe = 1010,                           /* -pipe */
  OPT_print_file_name_ = 1011,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1012,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1013,          /* -print-multi-directory */
  OPT_print_multi_lib = 1014,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1015,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1016,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1017,               /* -print-prog-name= */
  OPT_print_search_dirs = 1018,              /* -print-search-dirs */
  OPT_print_sysroot = 1019,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1020,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1021,                          /* -quiet */
  OPT_r = 1022,                              /* -r */
  OPT_remap = 1023,                          /* -remap */
  OPT_s = 1024,                              /* -s */
  OPT_s_bc_abi = 1025,                       /* -s-bc-abi */
  OPT_save_temps = 1026,                     /* -save-temps */
  OPT_save_temps_ = 1027,                    /* -save-temps= */
  OPT_shared = 1028,                         /* -shared */
  OPT_shared_libgcc = 1029,                  /* -shared-libgcc */
  /* OPT_specs = 1030, */                    /* -specs */
  OPT_specs_ = 1031,                         /* -specs= */
  OPT_static = 1032,                         /* -static */
  OPT_static_libgcc = 1033,                  /* -static-libgcc */
  OPT_static_libgcj = 1034,                  /* -static-libgcj */
  OPT_static_libgfortran = 1035,             /* -static-libgfortran */
  OPT_static_libgo = 1036,                   /* -static-libgo */
  OPT_static_libstdc__ = 1037,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1038, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1039, */                /* -std=c++0x */
  OPT_std_c__11 = 1040,                      /* -std=c++11 */
  OPT_std_c__98 = 1041,                      /* -std=c++98 */
  OPT_std_c11 = 1042,                        /* -std=c11 */
  ...
  OPT_std_f2008ts = 1050,                    /* -std=f2008ts */
  OPT_std_f95 = 1051,                        /* -std=f95 */
  OPT_std_gnu = 1052,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1053, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1054, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1055,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1056,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1057,                      /* -std=gnu11 */
  ...
  /* OPT_std_iso9899_2011 = 1067, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1068,                     /* -std=legacy */
  OPT_symbolic = 1069,                       /* -symbolic */
  OPT_t = 1070,                              /* -t */
  OPT_time = 1071,                           /* -time */
  OPT_time_ = 1072,                          /* -time= */
  OPT_traditional = 1073,                    /* -traditional */
  OPT_traditional_cpp = 1074,                /* -traditional-cpp */
  OPT_trigraphs = 1075,                      /* -trigraphs */
  OPT_u = 1076,                              /* -u */
  OPT_undef = 1077,                          /* -undef */
  OPT_v = 1078,                              /* -v */
  OPT_version = 1079,                        /* -version */
  OPT_w = 1080,                              /* -w */
  OPT_wrapper = 1081,                        /* -wrapper */
  OPT_x = 1082,                              /* -x */
  OPT_z = 1083,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
